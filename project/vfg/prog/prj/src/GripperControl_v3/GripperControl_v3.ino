...
//======================= Global Variables ========================
//BELT1
MotorControlPins* m_b1_pins = new MotorControlPins(3, 2, 23, 25, A11);   //Motor 1 Arduino pins
...
//BELT2
MotorControlPins* m_b2_pins = new MotorControlPins(9, 8, 31, 33, A8);   //Motor 1 Arduino pins
...
MotorControlPins* m_b4_pins = new MotorControlPins(7, 6, 29, 33, A9);   //Motor 1 Arduino pins
...
void setup() {
  ...
  */
  //Serial1.begin(19200); //open a serial connection
...
void setOn(const std_srvs::Empty::Request &req, std_srvs::Empty::Response &res) {
  ...
  digitalWrite(m_b1_pins->EN_, HIGH); //Enable the driver board
  digitalWrite(m_b3_pins->EN_, HIGH); //Enable the driver board
...
void setOff(const std_srvs::Empty::Request &req, std_srvs::Empty::Response &res) {
  ...
  digitalWrite(m_b3_pins->EN_, LOW); //Enable the driver board
  digitalWrite(m_oc_pins->EN_, LOW); //Enable the driver board
